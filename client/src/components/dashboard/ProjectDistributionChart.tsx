...
const STATUS_COLORS: Record<string, string> = {
    // Начальные этапы
    'Не начат': '#d4d4d4',                    // Gray
    'Формирование запроса': '#B0BEC5',        // Blue Gray
    'Сбор исходных данных': '#90A4AE',        // Blue Gray darker
    'Установочная встреча': '#78909C',        // Blue Gray even darker
    // Предпроектные этапы
    'Подготовка требований': '#CE93D8',       // Purple light
    'Формирование ТЗ': '#BA68C8',             // Purple
    'Актуализация ТЗ': '#AB47BC',             // Purple darker
    // Коммерческие этапы
    'Получение ОС и формирование КП': '#FFB74D', // Orange
    'Обсуждение КП': '#FFA726',               // Orange darker
    'Подписание договора': '#FF9800',         // Orange even darker
    // Реализация
    'Инициация реализации': '#64B5F6',        // Blue light
    'Проектирование': '#42A5F5',              // Blue
    'Прототипирование и дизайн': '#2196F3',   // Blue darker
    'Разработка программного кода': '#1E88E5', // Blue even darker
    'Тестирование': '#1976D2',                // Blue deep
    'Развертывание': '#1565C0',               // Blue deep darker
    'Демо': '#0D47A1',                        // Blue deepest
    // Завершающие этапы
    'Пилот': '#FF94DB',                       // Pink
    'Публикация': '#F48FB1',                  // Pink light
    'Приемка': '#4DB6AC',                     // Teal
    'План доработок': '#26A69A',              // Teal darker
    'Закрытие проекта': '#00897B',            // Teal deep
    // Финальные статусы
    'Готово': '#05CD99',                      // Green
    'На поддержке': '#6FD439',                // Light Green
    'Пауза': '#e6c258',                       // Yellow
    'пауза': '#e6c258'                        // Yellow (lowercase variant)
};
...
const STATUS_LABELS: Record<string, string> = {
    'Не начат': 'Не начат',
    'Формирование запроса': 'Форм.\nзапроса',
    'Сбор исходных данных': 'Сбор\nданных',
    'Установочная встреча': 'Устан.\nвстреча',
    'Подготовка требований': 'Подгот.\nтреб.',
    'Формирование ТЗ': 'Форм.\nТЗ',
    'Актуализация ТЗ': 'Актуал.\nТЗ',
    'Получение ОС и формирование КП': 'ОС и КП',
    'Обсуждение КП': 'Обсужд.\nКП',
    'Подписание договора': 'Подпис.\nдоговора',
    'Инициация реализации': 'Иниц.\nреализ.',
    'Проектирование': 'Проект.',
    'Прототипирование и дизайн': 'Прототип\nи дизайн',
    'Разработка программного кода': 'Разраб.\nкода',
    'Тестирование': 'Тестир.',
...
export default function ProjectDistributionChart({
    ...
    const allStatuses = [
        'Не начат', 'Формирование запроса', 'Сбор исходных данных', 'Установочная встреча',
        'Подготовка требований', 'Формирование ТЗ', 'Актуализация ТЗ',
        'Получение ОС и формирование КП', 'Обсуждение КП', 'Подписание договора',
        'Инициация реализации', 'Проектирование', 'Прототипирование и дизайн',
        'Разработка программного кода', 'Тестирование', 'Развертывание', 'Демо',
        'Пилот', 'Публикация', 'Приемка', 'План доработок', 'Закрытие проекта',
        'Готово', 'На поддержке', 'Пауза'
    ];

    const completedPhases = ['Готово', 'На поддержке', 'Отмена'];
    const completedStatuses = ['Готово', 'На поддержке', 'Закрытие проекта'];
